    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-muted">
          Mua lẻ theo nhu cầu, hoặc chọn trọn bộ lộ trình 5 combo + ebook để
          tiết kiệm và đi nhanh hơn.
        </p>
      </div>
        ...
        <div className="flex flex-col items-center gap-6 p-8 sm:flex-row sm:justify-between sm:p-10">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold sm:text-3xl">
              Trọn bộ lộ trình: Ebook + 5 combo + AI Sales System
            </h2>
          ...
          <div className="text-center sm:text-right">
            <p className="text-sm text-muted line-through">
              {formatVnd(BUNDLE_ORIGINAL_PRICE)}
            </p>
            <p className="text-3xl font-extrabold text-gold">
              {formatVnd(BUNDLE_PRICE)}
            </p>
            <Link
              href="/dang-nhap"
      ...
      {/* Combos */}
      <div className="mt-16">
        <h2 className="text-2xl font-bold">Lộ trình 5 combo</h2>
          ...
          {COMBOS.map((c, i) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center justify-between border-t border-border pt-4">
                <div>
                  <p className="font-bold text-gold">{c.priceLabel}</p>
                  <p className="text-xs text-muted">{c.lessonsCount} bài học</p>
                </div>
                <Link
                  href="/dang-nhap"
      ...
      <p className="mt-10 text-center text-xs text-muted">
        Tổng {ALL_PRODUCTS.length} sản phẩm trong hệ sinh thái AI Sales
        Academy. Nút &quot;Mua ngay&quot; hiện dẫn tới trang đăng nhập —
        kết nối cổng thanh toán thật khi triển khai chính thức.
      </p>
    </div>
  );
}
